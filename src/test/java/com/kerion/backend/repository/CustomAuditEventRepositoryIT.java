package com.kerion.backend.repository;

import com.kerion.backend.BackendKerionApp;
import com.kerion.backend.config.Constants;
import com.kerion.backend.config.audit.AuditEventConverter;
import com.kerion.backend.domain.PersistentAuditEvent;
...
import static com.kerion.backend.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
